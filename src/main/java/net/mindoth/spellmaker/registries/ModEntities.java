...
public class ModEntities {
    ...
    public static ResourceKey<EntityType<?>> SPELL_PROJECTILE_SINGLE_KEY = ResourceKey.create(Registries.ENTITY_TYPE, Identifier.withDefaultNamespace("spell_projectile_single"));
    ...
    public static ResourceKey<EntityType<?>> SPELL_PROJECTILE_MULTI_KEY = ResourceKey.create(Registries.ENTITY_TYPE, Identifier.withDefaultNamespace("spell_projectile_multi"));
