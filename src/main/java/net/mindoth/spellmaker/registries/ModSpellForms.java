...
public class ModSpellForms {
    ...
    public static final RegistryObject<SpellForm> CASTER_ONLY = registerSpellForm(new CasterOnlyForm("caster_only", 0));
    public static final RegistryObject<SpellForm> BY_TOUCH = registerSpellForm(new ByTouchForm("by_touch", 1));
    public static final RegistryObject<SpellForm> SINGLE_TARGET_AT_RANGE = registerSpellForm(new SingleTargetAtRangeForm("single_target_at_range", 2));
    public static final RegistryObject<SpellForm> AREA_AROUND_CASTER = registerSpellForm(new AreaAroundCasterForm("area_around_caster", 1));
    public static final RegistryObject<SpellForm> AREA_AT_RANGE = registerSpellForm(new AreaAtRangeForm("area_at_range", 3));
