...
public abstract class DataHelper {
    ...
    public static LinkedHashMap<AbstractSigilItem, List<Integer>> createMapFromTag(CompoundTag tag) {
        List<AbstractSigilItem> sigilList = DataHelper.getSigilListFromString(tag.getString(ParchmentItem.NBT_KEY_SPELL_SIGILS));
    ...
    public static List<AbstractSigilItem> getSigilListFromString(String stringList) {
        ...
        for ( String string : List.of(stringList.split(",")) ) {
            if ( BuiltInRegistries.ITEM.get(ResourceLocation.parse(string)) instanceof AbstractSigilItem sigil ) list.add(sigil);
        }
        return list;
    }
