...
public class ForestRobeModel<S extends HumanoidRenderState> extends HumanoidModel<S> {

    public ForestRobeModel(ModelPart root) {
        super(root);
    }

    public static ArmorModelSet<LayerDefinition> FOREST_ROBE_ARMOR_HOOD_LAYER = ForestRobeModel.createArmorSet()
            .map(mesh -> LayerDefinition.create(mesh, 64, 64));

    public static LayerDefinition createLayerByType(ForestRobeItem item) {
    ...
    public static LayerDefinition createHeadLayer() {
        return FOREST_ROBE_ARMOR_HOOD_LAYER.head();
    }
    public static LayerDefinition createBodyLayer() {
        return FOREST_ROBE_ARMOR_HOOD_LAYER.chest();
    }
    public static LayerDefinition createLegsLayer() {
        return FOREST_ROBE_ARMOR_HOOD_LAYER.legs();
    }
    public static LayerDefinition createBootsLayer() {
        return FOREST_ROBE_ARMOR_HOOD_LAYER.feet();
    }

    public static ArmorModelSet<MeshDefinition> createArmorSet() {
        return createArmorSet(scale -> createBaseArmor(scale));
    }
    ...
    public static MeshDefinition createBaseArmor(CubeDeformation scale) {
        ...
        hatPart.addOrReplaceChild("horns", CubeListBuilder.create().texOffs(0, 35)
                        .addBox(4.0F, -36.0F, 0.0F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(8, 35)
                        .addBox(-12.0F, -36.0F, 0.0F, 8.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)),
