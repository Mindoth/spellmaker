...
public class ArcaneRobeModel<S extends HumanoidRenderState> extends HumanoidModel<S> {
    ...
    public static ArmorModelSet<LayerDefinition> ARCANE_ROBE_ARMOR_HOOD_LAYER = ArcaneRobeModel.createArmorSet(true)
    ...
    public static LayerDefinition createHeadLayer(boolean isHood) {
        return isHood ? ARCANE_ROBE_ARMOR_HOOD_LAYER.head() : ARCANE_ROBE_ARMOR_HAT_LAYER.head();
    }
    public static LayerDefinition createBodyLayer() {
        return ARCANE_ROBE_ARMOR_HOOD_LAYER.chest();
    }
    public static LayerDefinition createLegsLayer() {
        return ARCANE_ROBE_ARMOR_HOOD_LAYER.legs();
    }
    public static LayerDefinition createBootsLayer() {
        return ARCANE_ROBE_ARMOR_HOOD_LAYER.feet();
    }
