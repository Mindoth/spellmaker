...
public class ArcaneRobeModel<S extends HumanoidRenderState> extends HumanoidModel<S> {

    public ArcaneRobeModel(ModelPart root) {
        super(root);
    }

    public static ArmorModelSet<LayerDefinition> ARCANE_ROBE_ARMOR_LAYER =
            ArcaneRobeModel.createArmorSet().map(mesh -> LayerDefinition.create(mesh, 64, 64));
    ...
    public static LayerDefinition createHeadLayer() {
        return ARCANE_ROBE_ARMOR_LAYER.head();
    }
    public static LayerDefinition createBodyLayer() {
        return ARCANE_ROBE_ARMOR_LAYER.chest();
    }
    public static LayerDefinition createLegsLayer() {
        return ARCANE_ROBE_ARMOR_LAYER.legs();
    }
    public static LayerDefinition createBootsLayer() {
        return ARCANE_ROBE_ARMOR_LAYER.feet();
    }

    public static ArmorModelSet<MeshDefinition> createArmorSet() {
        return createArmorSet(ArcaneRobeModel::createBaseArmor);
    }
