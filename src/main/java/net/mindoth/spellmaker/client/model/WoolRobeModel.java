...
public class WoolRobeModel<S extends HumanoidRenderState> extends HumanoidModel<S> {

    public WoolRobeModel(ModelPart root) {
        super(root);
    }
    ...
    public static LayerDefinition createLayerByType(WoolRobeItem item) {
    ...
    public static LayerDefinition createArmorModel(boolean isHood) {
        CubeDeformation scale = new CubeDeformation(1.0F);
        MeshDefinition mesh = HumanoidModel.createMesh(scale, 0);
        PartDefinition root = mesh.getRoot();
