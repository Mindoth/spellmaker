...
public class CalcinatorScreen extends AbstractCalcinatorScreen<CalcinatorMenu> {
    ...
    private static final Identifier LIT_PROGRESS_SPRITE = Identifier.fromNamespaceAndPath(SpellMaker.MOD_ID, "textures/gui/calcinator_lit_progress.png");
    private static final Identifier BURN_PROGRESS_SPRITE = Identifier.fromNamespaceAndPath(SpellMaker.MOD_ID, "textures/gui/calcinator_burn_progress.png");
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(SpellMaker.MOD_ID, "textures/gui/calcinator_screen.png");
