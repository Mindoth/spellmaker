...
public class StunScreen extends ChatScreen {
    public StunScreen(String pInitial) {
        super(pInitial);
    }
    ...
    public static void clientStunTick(TickEvent.ClientTickEvent event) {
        ...
        if ( instance.player != null ) {
            ...
            if ( AbstractStunEffect.isStunned(player) ) {
                if ( !(instance.screen instanceof StunScreen) && (instance.screen == null || !instance.screen.isPauseScreen()) ) {
                    instance.setScreen(new StunScreen(""));
                }
            }
            else if ( instance.screen instanceof StunScreen ) player.closeContainer();
        }
    }
}
