...
public abstract class AbstractAlembicScreen<T extends AlembicMenu> extends AbstractContainerScreen<T> {
    ...
    public AbstractAlembicScreen(T menu, Inventory playerInventory, Component title) {
